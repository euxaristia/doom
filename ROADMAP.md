...
- **105 V files** in `vdoom/core/`
- **72 C files** in `crispy-doom/src/doom/`
- ~60% complete for core game structures
- ~10% complete for actual game logic
...
#### 2.3 Map & Collision
- [ ] p_map.v - Movement collision detection
- [ ] p_map.v - Blockmap traversal
